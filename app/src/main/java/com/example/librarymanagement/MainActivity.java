...
public class MainActivity extends AppCompatActivity {
    ...
    public void register(){
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()==false){
                    //toast(MainActivity.this,"Please Fill in the correct format");
                    ...
                    login();
                    toast(MainActivity.this,"Registered Successfully Please Login");
                    username.setText("");
                    name.setText("");
                    email.setText("");
                    password.setText("");
                    ...
                    toast(MainActivity.this,"Error PLease try again");
                }
            }
        });
    }
    public boolean validate() {
        ...
        if (username.getText().toString().trim().length() == 0 ||
            ...
            if (!android.util.Patterns.EMAIL_ADDRESS.matcher(email.getText().toString()).matches()) {
                ...
                toast(MainActivity.this, "Please enter valid email!");
            } else {
                valid = true;
                email.setError(null);
            }
        ...
        if (password.length() > 8 || cpassword.length() > 8){
            ...
            valid = false;
            toast(MainActivity.this,"Password must be 8 characters long");
        }
